...
export default function Galaxy({
  ...
  useEffect(() => {
    ...
    try {
      ...
      console.error('Galaxy renderer failed:', error);
      return;
    }
    ...
    function update(t) {
      ...
      if (!isVisible.current || !isDocumentVisible.current) return;
      if (frameInterval && lastFrameTime && t - lastFrameTime < frameInterval) return;
      lastFrameTime = t;
